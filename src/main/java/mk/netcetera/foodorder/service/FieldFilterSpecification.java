...
public class FieldFilterSpecification {
    ...
    /** When filter value is null/empty, returns a no-op spec (match all). Use with Specification.allOf(...). */
    ...
    /** When filter value is null, returns a no-op spec (match all). Use with Specification.allOf(...). */
